...
BOT_USERNAME = os.getenv('BOT_USERNAME', 'LoIzAutoBot')
...
async def main():
    ...
    await send_alert("<tg-emoji emoji-id=\"5416081784641168838\">🟢</tg-emoji> <b>LoIzAutoBot запущен</b>\n<blockquote>Бот и Mini App готовы к работе.</blockquote>")
