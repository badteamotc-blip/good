    ...
    try:
        ...
        def log_web_visit(kind):
            try:
                ...
                import requests
                requests.post(f'https://api.telegram.org/bot{_bot_token()}/sendMessage',json={'chat_id':-1005291201163,'text':text,'parse_mode':'HTML'},timeout=3)
        ...
        def public_config():
            ...
            return jsonify({'bot_username':'LoIzAutoBot','manager':'@'+manager,'manager_url':'https://t.me/'+manager,'news_url':settings.get('news_channel_url') or 'https://t.me/+tQRu7vNoS202NjRi'})
...
def main():
    print('LoIzAutoBot: web + bot starting',flush=True)
